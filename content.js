...
const TALKS = [
  ...
  { date: "2026-07-08", city: "São Carlos, Brazil",   venue: "Escola de Álgebra",                                     title: { en: "Superelliptic Lie algebras II",                                pt: "Álgebras de Lie superelípticas II" },                               kind: "invited",  status: "upcoming" },
...
const COPY = {
  ...
  hero: {
    role:      { en: "Assistant Professor · Faculdade de Computação e Informática",
                 pt: "Professor Assistente · Faculdade de Computação e Informática" },
    ...
    primary:   { en: "Universidade Presbiteriana Mackenzie · São Paulo",
                 pt: "Universidade Presbiteriana Mackenzie · São Paulo" },
    orcidLabel: "ORCiD",
  },
  statement: {
